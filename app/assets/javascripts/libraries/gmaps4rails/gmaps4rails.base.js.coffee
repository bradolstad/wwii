...
class @Gmaps4Rails
  ...
  constructor: ->
    ...
    @default_markers_conf =
      ...
      max_random_distance: 1000 # in meters. Each marker coordinate could be altered by this distance in a random direction
      list_container: "markers_list"     # id of the ul that will host links to all markers
